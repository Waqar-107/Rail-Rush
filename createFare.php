                ...
                <div class="panel-body">
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            <input type="text" name="start" id="start" class="form-control" placeholder="starting">
                        </div>
                        ...
                        <div class="form-group">
                            <input type="text" name="tid" id="tid" class="form-control" placeholder="train id">
                        </div>

                        <div class="form-group">
                            <input type="text" name="stype" id="stype" class="form-control" placeholder="seat type">
                        </div>
